    ...
    public class EmployeesController : Controller
    {
        ...
        public IEnumerable<Employee> GetEmployee([FromQuery] string query)
        {
            if (!String.IsNullOrWhiteSpace(query))
                return _context.Employee.Where(e => e.LoginId.Contains(query)).Include(e => e.BusinessEntity);
        ...
        public async Task<IActionResult> GetEmployee([FromRoute] int id)
        {
            ...
            var employee = await _context.Employee.Include(e => e.BusinessEntity).SingleOrDefaultAsync(m => m.BusinessEntityId == id);
